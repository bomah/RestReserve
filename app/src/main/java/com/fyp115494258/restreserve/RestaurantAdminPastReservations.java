 ...
 */
public class RestaurantAdminPastReservations extends Fragment {


    View RestaurantAdminPastReservationsView;
    ...
    public RestaurantAdminPastReservations() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RestaurantAdminPastReservationsView=inflater.inflate(R.layout.fragment_restaurant_admin_past_reservations, container, false);
        ...
        //Init
        recyclerView = RestaurantAdminPastReservationsView.findViewById(R.id.listPastReservations);
        ...
        return RestaurantAdminPastReservationsView;
